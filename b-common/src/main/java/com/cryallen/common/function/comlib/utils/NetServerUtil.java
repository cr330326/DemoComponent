...
public class NetServerUtil {
    private final static String TAG = "NetServerUtil";

    public NetServerUtil() {}

    /**
     * 获取网络类型
     *
     * @param context
     * @return -1 没有网络、1 wifi、0 非wifi、其他类型网络 int -1 没有网络、1 wifi、0 非wifi、 其他类型网络
     * @since V1.0
     */
    ...
    public static boolean connectToSocketWifi(WifiManager manager, String wifiSSID) {
        EFLog.i(TAG,"要连接的socket wifi====>" + wifiSSID);
    ...
    public static WifiConfiguration getWifiConfiguration(WifiManager manager, String ssid, String
        ...
        for (ScanResult scResult : list) {
            if (ssid.equals(scResult.SSID)) {
                ...
                EFLog.i(TAG,"capabilities=" + capabilities);
    ...
    public static boolean pingTest(String IPOrDomainName) {
        ...
        EFLog.d(TAG,"Ping result = " + result);
        return isSuccess;
    }
