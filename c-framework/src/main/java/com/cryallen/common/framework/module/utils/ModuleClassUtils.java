package com.cryallen.common.framework.module.utils;
    ...
    public static <T> List<T> getObjectsWithInterface(Context context, Class<T> clazz, String path) {
        ...
        try {
            ...
            if (objectList.size() == 0) {
                EFLog.e(TAG, "No files were found, check your configuration please!");
            }
        } catch (Exception e) {
            e.getStackTrace();
            EFLog.e(TAG, "getObjectsWithInterface error, " + e.getMessage());
        }
    ...
    public static List<String> getFileNameByPackageName(Context context, String packageName) throws PackageManager.NameNotFoundException, IOException {
        ...
        for (String path : getSourcePaths(context)) {
            ...
            try {
                ...
                EFLog.e(TAG, "Scan map file in dex files made error. "+ ignore);
            }
            finally {
                if (null != dexfile) {
                    try {
        ...
        EFLog.d(TAG, "Filter " + classNames.size() + " classes by packageName <" + packageName + ">");
        return classNames;
    }
